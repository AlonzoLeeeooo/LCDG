...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("-l", "--logdir", type=str, default="workdir/verbose_training", help="directory for logging, saving checkpoints and tensorboard logs")
    ...
    parser.add_argument("--eval_freq", type=int, default=0, help='the frequency of evalution, 0 represents not using evaluation')
...
if __name__ == '__main__':
    ...
    mode = model_configs['condition_adaptor_config']['mode']
    args.use_style_loss = True if model_configs['condition_adaptor_config']['cond_type'] == "style" else False
    ...
    # TODO: setup basic DDP parameters
